...
export const BriefIntro = () => {
  ...
  const resetBrief = useBriefStore(state => state.resetBrief);
      ...
      <section className="mx-auto w-full max-w-5xl px-4 py-4 font-sans text-black lg:py-6">
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center">
            <NeobrutalistButton type="button" onClick={() => {}} text="..." />
            <div className="flex flex-col items-start gap-2 text-gray-400 sm:flex-row sm:items-center md:gap-4">
              <Label variant="ghost" labelText="..." icon="Clock" className="px-0" />
              <Label variant="ghost" labelText="..." icon="ShieldCheck" className="px-0" />
            </div>
          </div>
        </div>
      </section>

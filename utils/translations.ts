export const enTranslations = {
  ...
  form: {
    ...
    errors: {
      ...
      error_phone_numbers_only: 'Please, add just numbers',
  ...
  brief: {
    ...
    steps: {
      step1: {
        ...
        phone: 'And your number?',
        phonePlaceholder: '+52 000 000 0000 (Optional)',
  ...
  brief: {
    ...
    steps: {
      step1: {
        ...
        phonePlaceholder: '+52 000 000 0000 (Opcional)',
